...
=======
>>>>>>> f0e058702ed64439450c0f9675e5127e27a6b86d
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription asChild>
              <div className="space-y-4 pt-2 text-left text-sm text-muted-foreground">
                ...
                {/* Correct PayPal Button usage */}
                <PaypalButton
                  productId="premium_once"
                  amount="8.00"
                  currency="USD"
                  description="Premium 15 days"
                />
                ...
                <div className="border-t border-border pt-4">
                  ...
                  <p>
                    Enjoy Premium Features for a limited time of 5 minutes when
                    opting into viewing 2 ads. No cap on how many times premium
                    features can be unlocked with ads.
                  </p>
                </div>
              </div>
            </AlertDialogDescription>
