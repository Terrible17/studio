export const countries = [
    ...
    { value: "congo-brazzaville", label: "Congo - Brazzaville", flag: "🇨🇬" },
    { value: "congo-kinshasa", label: "Congo - Kinshasa", flag: "🇨🇩" },
    ...
    { value: "czechia", label: "Czechia", flag: "🇨🇿" },
    ...
    { value: "ivory-coast", label: "Côte d’Ivoire", flag: "🇨🇮" },
    ...
    { value: "myanmar", label: "Myanmar (Burma)", flag: "🇲🇲" },
    ...
    { value: "sao-tome-and-principe", label: "São Tomé & Príncipe", flag: "🇸🇹" },
    ...
    { value: "st-kitts-and-nevis", label: "St. Kitts & Nevis", flag: "🇰🇳" },
    { value: "st-lucia", label: "St. Lucia", flag: "🇱🇨" },
    { value: "st-vincent-and-the-grenadines", label: "St. Vincent & the Grenadines", flag: "🇻🇨" },
    ...
    { value: "trinidad-and-tobago", label: "Trinidad & Tobago", flag: "🇹🇹" },
